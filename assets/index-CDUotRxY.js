...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(e,t,n){return new pi({name:`SphericalGaussianBlur`,defines:{SAMPLES:za,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:ro(),fragmentShader:`
	...
	`}var io=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Xr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`})}_getEdgeDetectionMaterial(){return new pi({uniforms:{maskTexture:{value:null},texSize:{value:new K(.5,.5)},visibleEdgeColor:{value:new q(1,1,1)},hiddenEdgeColor:{value:new q(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getSeparableBlurMaterial(e){return new pi({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new K(.5,.5)},direction:{value:new K(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getOverlayMaterial(){return new pi({uniforms:{maskTexture:{value:null},edgeTexture1:{value:null},edgeTexture2:{value:null},patternTexture:{value:null},edgeStrength:{value:1},edgeGlow:{value:1},usePatternTexture:{value:0}},vertexShader:`varying vec2 vUv;
				...
				}`,blending:2,depthTest:!1,depthWrite:!1,transparent:!0})}};cl.BlurDirectionX=new K(1,0),cl.BlurDirectionY=new K(0,1);var ll={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ul=class extends $c{constructor(){super(),this.isOutputPass=!0,this.uniforms=li.clone(ll.uniforms),this.material=new mi({name:ll.name,uniforms:this.uniforms,vertexShader:ll.vertexShader,fragmentShader:ll.fragmentShader}),this._fsQuad=new nl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},dl=document.createElement(`canvas`);document.body.appendChild(dl);var fl=new Uc({canvas:dl,antialias:!0});fl.shadowMap.enabled=!0;var pl=new dn;pl.background=new X(1118481);var ml=new Yi(45,9/16,20,2e3);ml.position.set(0,50,40),ml.lookAt(0,0,0);var hl=new $i(16777215,.4);pl.add(hl);var gl=new Qi(16777215,.8);gl.position.set(20,50,20),gl.castShadow=!0,gl.shadow.mapSize.width=2048,gl.shadow.mapSize.height=2048,gl.shadow.camera.left=-30,gl.shadow.camera.right=30,gl.shadow.camera.top=30,gl.shadow.camera.bottom=-30,pl.add(gl);var _l=new Wc,vl=new Kc,yl=new Zc(pl);document.addEventListener(`click`,()=>Yc.init(),{once:!0});var bl=0,xl=`charging`,Sl=0,Cl=new q,wl=null,Tl=!1,El=new ol(fl),Dl=new sl(pl,ml);El.addPass(Dl);var Ol=new cl(new K(window.innerWidth,window.innerHeight),pl,ml);Ol.edgeStrength=3,Ol.edgeGlow=0,Ol.edgeThickness=.5,Ol.visibleEdgeColor.set(0),Ol.hiddenEdgeColor.set($.colors.zombie),Ol.materialCopy&&(Ol.materialCopy.blending=2,Ol.materialCopy.transparent=!0),El.addPass(Ol);var kl=new cl(new K(window.innerWidth,window.innerHeight),pl,ml);kl.edgeStrength=3,kl.edgeGlow=0,kl.edgeThickness=.5,kl.visibleEdgeColor.set(0),kl.hiddenEdgeColor.set($.colors.civilian),kl.materialCopy&&(kl.materialCopy.blending=2,kl.materialCopy.transparent=!0),El.addPass(kl);var Al=new cl(new K(window.innerWidth,window.innerHeight),pl,ml);Al.edgeStrength=3,Al.edgeGlow=0,Al.edgeThickness=.5,Al.visibleEdgeColor.set(0),Al.hiddenEdgeColor.set($.colors.soldier),Al.materialCopy&&(Al.materialCopy.blending=2,Al.materialCopy.transparent=!0),El.addPass(Al);var jl=new ul;El.addPass(jl);var Ml=0;function Nl(){Ml=document.getElementById(`ui-layer`).classList.contains(`hidden`)?0:340;let e=window.innerWidth,t=window.innerHeight;fl.setSize(e,t),El.setSize(e,t),ml.aspect=e/t,ml.updateProjectionMatrix(),fl.domElement.style.position=`absolute`,fl.domElement.style.left=`0px`,fl.domElement.style.top=`0px`;let n=document.getElementById(`minimap-container`);n&&(n.style.top=`auto`,n.style.bottom=`20px`,n.style.right=`${Ml+20}px`)}window.addEventListener(`resize`,Nl),Nl();var Pl=[],Fl=[],Il=[],Ll=20,Rl=!0,zl=!1,Bl=1;window.getGameState=()=>({zombies:Pl.length,humans:Fl.length,soldiers:Il.length,isGameStarted:lu,currentCount:Bl});var Vl=0,Hl=0,Ul=0,Wl=!1,Gl=!1,Kl=0,ql=0,Jl=30;function Yl(e,t){let n=vl.worldToGrid(e,t);if(vl.isWalkable(n.gx,n.gz))return{x:e,z:t};for(let n=0;n<50;n++){let n=e+(Math.random()-.5)*40,r=t+(Math.random()-.5)*40,i=vl.worldToGrid(n,r);if(vl.isWalkable(i.gx,i.gz))return{x:n,z:r}}return{x:e,z:t}}function Xl(e){Bl=e,Gl=!1,bl=0,Sl=0,xl=`charging`,Tl=!1,document.body.style.cursor=`default`,wl&&=(pl.remove(wl),wl.geometry.dispose(),wl.material.dispose(),null);let t=document.getElementById(`flare-ui`);t&&(t.style.borderColor=`#666`);let n=document.getElementById(`flare-progress`);n&&(n.style.height=`0%`);let r=document.getElementById(`flare-text`);r&&(r.textContent=`충전중`),Pl.forEach(e=>e.destroy()),Pl=[],Fl.forEach(e=>e.destroy()),Fl=[],Il.forEach(e=>e.destroy()),Il=[],cu=0,lu=!1,Ll=20,Rl=!0,document.getElementById(`play-time-display`).textContent=`00:00`;let i=[`normal`,`fast`,`slow`],a=Math.ceil(Math.sqrt(e)),o=-((a-1)*1.5)/2,s=-((a-1)*1.5)/2,c=0;for(let t=0;t<a;t++)for(let n=0;n<a&&!(c>=e);n++){let e=i[c%i.length],r=Yl(o+t*1.5,s+n*1.5);Pl.push(new qc(pl,e,r.x,r.z)),c++}let l=parseInt(document.getElementById(`inp-civ-count`).value)||0;for(let e=0;e<l;e++){let t,n;if(e<15){let r=e/15*Math.PI*2,i=25+Math.random()*10;t=Math.cos(r)*i,n=Math.sin(r)*i}else t=(Math.random()-.5)*$.mapSize,n=(Math.random()-.5)*$.mapSize,Math.abs(t)<25&&Math.abs(n)<25&&(t+=t>0?30:-30,n+=n>0?30:-30);let r=Yl(t,n);Fl.push(new Jc(pl,r.x,r.z))}Vl=0,Hl=0,Ul=0,Wl=!1;let u=document.getElementById(`camera-mode`);u&&(u.textContent=`자동 추적`);let d=document.getElementById(`hud-zombie-count`);d&&(d.textContent=e),_l.reset(),document.getElementById(`input-display`).textContent=`(0.00, 0.00)`,Ol.selectedObjects=Pl.map(e=>e.mesh),kl.selectedObjects=Fl.map(e=>e.mesh),Al.selectedObjects=Il.map(e=>e.mesh)}document.getElementById(`btn-count-1`).addEventListener(`click`,()=>Xl(1)),document.getElementById(`btn-count-10`).addEventListener(`click`,()=>Xl(10)),document.getElementById(`btn-count-40`).addEventListener(`click`,()=>Xl(40)),document.getElementById(`chk-debug`).addEventListener(`change`,e=>{zl=e.target.checked,yl.updateDebug(zl,vl)});var Zl=document.getElementById(`flare-ui`);Zl&&Zl.addEventListener(`click`,e=>{(xl===`ready`||xl===`charging`&&bl>=15)&&(Tl=!0,document.body.style.cursor=`crosshair`,Zl.style.borderColor=`#ff3333`)}),window.addEventListener(`resize`,()=>{ml.aspect=window.innerWidth/window.innerHeight,ml.updateProjectionMatrix(),fl.setSize(window.innerWidth,window.innerHeight),El.setSize(window.innerWidth,window.innerHeight)});var Ql=2.3,$l=100,eu=.6,tu=0,nu=0,ru=.2,iu=localStorage.getItem(`zombie_settings_v2`);if(iu)try{let e=JSON.parse(iu);e.camDist!==void 0&&(document.getElementById(`sl-cam-dist`).value=e.camDist),e.camMax!==void 0&&(document.getElementById(`sl-cam-max`).value=e.camMax),e.camAngle!==void 0&&(document.getElementById(`sl-cam-angle`).value=e.camAngle),e.camSpeedFollow!==void 0&&(document.getElementById(`sl-cam-speed-follow`).value=e.camSpeedFollow),e.camSpeedZoom!==void 0&&(document.getElementById(`sl-cam-speed-zoom`).value=e.camSpeedZoom),e.camDragSpeed!==void 0&&document.getElementById(`inp-cam-drag-speed`)&&(document.getElementById(`inp-cam-drag-speed`).value=e.camDragSpeed),e.bldgAmt!==void 0&&(document.getElementById(`sl-bldg-amount`).value=e.bldgAmt),e.bldgDen!==void 0&&(document.getElementById(`sl-bldg-density`).value=e.bldgDen),e.bldgHgt!==void 0&&(document.getElementById(`sl-bldg-height`).value=e.bldgHgt),e.bldgVar!==void 0&&(document.getElementById(`sl-bldg-var`).value=e.bldgVar),e.bldgRot!==void 0&&(document.getElementById(`sl-bldg-rot`).value=e.bldgRot),e.colMargin!==void 0&&(document.getElementById(`sl-col-margin`).value=e.colMargin),e.spawnCivCount!==void 0&&(document.getElementById(`inp-civ-count`).value=e.spawnCivCount),e.spawnSolCount!==void 0&&(document.getElementById(`inp-sol-count`).value=e.spawnSolCount),e.spawnSolInterval!==void 0&&(document.getElementById(`inp-sol-interval`).value=e.spawnSolInterval),e.stats&&Object.keys(e.stats).forEach(t=>{$.stats[t]&&Object.assign($.stats[t],e.stats[t])})}catch{}var au=!1,ou=document.getElementById(`btn-toggle-ui`),su=document.getElementById(`ui-layer`);ou.addEventListener(`click`,()=>{su.classList.toggle(`hidden`),ou.classList.toggle(`panel-hidden`),au=!su.classList.contains(`hidden`),ou.textContent=au?`▶ 패널 접기`:`◀ 패널 열기`,Nl()});var cu=0,lu=!1,uu=document.getElementById(`play-time-display`);function du(e){let t=Math.floor(e/60),n=Math.floor(e%60);return`${t.toString().padStart(2,`0`)}:${n.toString().padStart(2,`0`)}`}document.getElementById(`btn-restart-game`).addEventListener(`click`,()=>{Wl=!1;let e=document.getElementById(`camera-mode`);e&&(e.textContent=`자동 추적`),document.getElementById(`btn-apply-map`).click(),Xl(1)}),document.getElementById(`btn-reset-exp`).addEventListener(`click`,()=>{Wl=!1;let e=document.getElementById(`camera-mode`);e&&(e.textContent=`자동 추적`),document.getElementById(`btn-apply-map`).click(),Xl(Bl)});var fu=document.getElementById(`sl-cam-dist`),pu=document.getElementById(`val-cam-dist`);Ql=parseFloat(fu.value),pu.textContent=Ql.toFixed(1),fu.addEventListener(`input`,e=>{Ql=parseFloat(e.target.value),pu.textContent=Ql.toFixed(1)});var mu=document.getElementById(`sl-cam-max`),hu=document.getElementById(`val-cam-max`);$l=parseInt(mu.value),hu.textContent=$l,mu.addEventListener(`input`,e=>{$l=parseInt(e.target.value),hu.textContent=$l});var gu=document.getElementById(`sl-cam-angle`),_u=document.getElementById(`val-cam-angle`);eu=parseFloat(gu.value),_u.textContent=eu.toFixed(1),gu.addEventListener(`input`,e=>{eu=parseFloat(e.target.value),_u.textContent=eu.toFixed(1)});var vu=document.getElementById(`sl-cam-speed-follow`),yu=document.getElementById(`val-cam-speed-follow`);tu=(parseInt(vu.value)-5.5)/4.5,yu.textContent=vu.value,vu.addEventListener(`input`,e=>{tu=(parseInt(e.target.value)-5.5)/4.5,yu.textContent=e.target.value});var bu=document.getElementById(`sl-cam-speed-zoom`),xu=document.getElementById(`val-cam-speed-zoom`);nu=(parseInt(bu.value)-5.5)/4.5,xu.textContent=bu.value,bu.addEventListener(`input`,e=>{nu=(parseInt(e.target.value)-5.5)/4.5,xu.textContent=e.target.value});var Su=document.getElementById(`inp-cam-drag-speed`);Su&&(ru=parseFloat(Su.value)||.2,Su.addEventListener(`input`,e=>{ru=parseFloat(e.target.value)||.2}));var Cu=document.getElementById(`chk-cam-auto-zoom`).checked;document.getElementById(`chk-cam-auto-zoom`).addEventListener(`change`,e=>{Cu=e.target.checked}),document.getElementById(`btn-cam-reset`).addEventListener(`click`,()=>{document.getElementById(`sl-cam-dist`).value=2.3,document.getElementById(`sl-cam-dist`).dispatchEvent(new Event(`input`)),document.getElementById(`sl-cam-angle`).value=.6,document.getElementById(`sl-cam-angle`).dispatchEvent(new Event(`input`)),document.getElementById(`sl-cam-speed-follow`).value=1,document.getElementById(`sl-cam-speed-follow`).dispatchEvent(new Event(`input`)),document.getElementById(`chk-cam-auto-zoom`).checked=!0,document.getElementById(`chk-cam-auto-zoom`).dispatchEvent(new Event(`change`)),document.getElementById(`sl-cam-max`).value=100,document.getElementById(`sl-cam-max`).dispatchEvent(new Event(`input`)),document.getElementById(`sl-cam-speed-zoom`).value=5,document.getElementById(`sl-cam-speed-zoom`).dispatchEvent(new Event(`input`)),document.getElementById(`inp-cam-drag-speed`)&&(document.getElementById(`inp-cam-drag-speed`).value=3,document.getElementById(`inp-cam-drag-speed`).dispatchEvent(new Event(`input`)))});var wu=document.getElementById(`sl-bldg-amount`),Tu=document.getElementById(`sl-bldg-density`),Eu=document.getElementById(`sl-bldg-height`),Du=document.getElementById(`sl-bldg-var`),Ou=document.getElementById(`sl-bldg-rot`),ku=document.getElementById(`sl-col-margin`),Au=document.getElementById(`val-bldg-amount`),ju=document.getElementById(`val-bldg-density`),Mu=document.getElementById(`val-bldg-height`),Nu=document.getElementById(`val-bldg-var`),Pu=document.getElementById(`val-bldg-rot`),Fu=document.getElementById(`val-col-margin`);Au.textContent=wu.value,ju.textContent=Tu.value,Mu.textContent=Eu.value,Nu.textContent=Du.value,Pu.textContent=Ou.value,Fu.textContent=ku.value,wu.addEventListener(`input`,e=>Au.textContent=e.target.value),Tu.addEventListener(`input`,e=>ju.textContent=e.target.value),Eu.addEventListener(`input`,e=>Mu.textContent=e.target.value),Du.addEventListener(`input`,e=>Nu.textContent=e.target.value),Ou.addEventListener(`input`,e=>Pu.textContent=e.target.value),ku.addEventListener(`input`,e=>Fu.textContent=e.target.value),[{id:`z-spd-min`,obj:`zombie`,key:`speedMin`,isFloat:!0},{id:`z-spd-max`,obj:`zombie`,key:`speedMax`,isFloat:!0},{id:`z-hp-min`,obj:`zombie`,key:`hpMin`,isFloat:!1},{id:`z-hp-max`,obj:`zombie`,key:`hpMax`,isFloat:!1},{id:`z-atk-min`,obj:`zombie`,key:`atkMin`,isFloat:!1},{id:`z-atk-max`,obj:`zombie`,key:`atkMax`,isFloat:!1},{id:`z-lunge-dist`,obj:`zombie`,key:`lungeDist`,isFloat:!0},{id:`z-lunge-spd`,obj:`zombie`,key:`lungeSpeedMult`,isFloat:!0},{id:`z-infect-time`,obj:`zombie`,key:`infectTime`,isFloat:!0},{id:`c-spd-min`,obj:`civilian`,key:`speedMin`,isFloat:!0},{id:`c-spd-max`,obj:`civilian`,key:`speedMax`,isFloat:!0},{id:`c-hp-min`,obj:`civilian`,key:`hpMin`,isFloat:!1},{id:`c-hp-max`,obj:`civilian`,key:`hpMax`,isFloat:!1},{id:`s-spd-min`,obj:`soldier`,key:`speedMin`,isFloat:!0},{id:`s-spd-max`,obj:`soldier`,key:`speedMax`,isFloat:!0},{id:`s-hp-min`,obj:`soldier`,key:`hpMin`,isFloat:!1},{id:`s-hp-max`,obj:`soldier`,key:`hpMax`,isFloat:!1},{id:`s-atk-min`,obj:`soldier`,key:`atkMin`,isFloat:!1},{id:`s-atk-max`,obj:`soldier`,key:`atkMax`,isFloat:!1}].forEach(e=>{let t=document.getElementById(`sl-`+e.id),n=document.getElementById(`val-`+e.id);if(!t||!n)return;let r=$.stats[e.obj][e.key];t.value=r,n.textContent=e.isFloat?r.toFixed(1):r,t.addEventListener(`input`,t=>{let r=e.isFloat?parseFloat(t.target.value):parseInt(t.target.value,10);$.stats[e.obj][e.key]=r,n.textContent=e.isFloat?r.toFixed(1):r})}),document.getElementById(`btn-save-settings`).addEventListener(`click`,()=>{let e={camDist:document.getElementById(`sl-cam-dist`).value,camMax:document.getElementById(`sl-cam-max`).value,camAngle:document.getElementById(`sl-cam-angle`).value,camSpeedFollow:document.getElementById(`sl-cam-speed-follow`).value,camSpeedZoom:document.getElementById(`sl-cam-speed-zoom`).value,camDragSpeed:document.getElementById(`inp-cam-drag-speed`)?document.getElementById(`inp-cam-drag-speed`).value:.2,bldgAmt:document.getElementById(`sl-bldg-amount`).value,bldgDen:document.getElementById(`sl-bldg-density`).value,bldgHgt:document.getElementById(`sl-bldg-height`).value,bldgVar:document.getElementById(`sl-bldg-var`).value,bldgRot:document.getElementById(`sl-bldg-rot`).value,colMargin:document.getElementById(`sl-col-margin`).value,spawnCivCount:document.getElementById(`inp-civ-count`).value,spawnSolCount:document.getElementById(`inp-sol-count`).value,spawnSolInterval:document.getElementById(`inp-sol-interval`).value,stats:$.stats};localStorage.setItem(`zombie_settings_v2`,JSON.stringify(e)),alert(`설정이 성공적으로 저장되었습니다!`)}),document.getElementById(`btn-apply-map`).addEventListener(`click`,()=>{let e=parseInt(wu.value),t=parseFloat(Tu.value),n=parseInt(Eu.value),r=parseFloat(Du.value),i=parseFloat(Ou.value),a=parseFloat(ku.value);Gc(e,t,n,r,i),yl.rebuildBuildings(),vl.buildGrid(a),zl&&(yl.updateDebug(!1,vl),yl.updateDebug(!0,vl))}),document.getElementById(`btn-reset-exp`).click();var Iu=document.getElementById(`minimap`),Lu=Iu.getContext(`2d`);function Ru(){Lu.clearRect(0,0,Iu.width,Iu.height);let e=Iu.width/$.mapSize,t=$.mapSize/2;Lu.strokeStyle=`#555`,Lu.strokeRect(0,0,Iu.width,Iu.height),Lu.fillStyle=`#888`,$.buildings.forEach(n=>{let r=(n.x-n.width/2+t)*e,i=(n.z-n.depth/2+t)*e,a=Math.cos(n.rotY||0),o=Math.sin(n.rotY||0),s=Math.abs(n.width*a)+Math.abs(n.depth*o),c=Math.abs(n.width*o)+Math.abs(n.depth*a),l=s*e,u=c*e;Lu.fillRect(r-(s-n.width)/2*e,i-(c-n.depth)/2*e,l,u)}),Lu.fillStyle=`#87CEEB`,Fl.forEach(n=>{let r=(n.mesh.position.x+t)*e,i=(n.mesh.position.z+t)*e;Lu.beginPath(),Lu.arc(r,i,1.5,0,Math.PI*2),Lu.fill()}),Lu.fillStyle=`#4CAF50`,Il.forEach(n=>{let r=(n.mesh.position.x+t)*e,i=(n.mesh.position.z+t)*e;Lu.beginPath(),Lu.arc(r,i,1.5,0,Math.PI*2),Lu.fill()}),Lu.fillStyle=`#FF0000`,Pl.forEach(n=>{let r=(n.mesh.position.x+t)*e,i=(n.mesh.position.z+t)*e;Lu.beginPath(),Lu.arc(r,i,2,0,Math.PI*2),Lu.fill()}),document.getElementById(`minimap-zombies`).textContent=Pl.length,document.getElementById(`minimap-humans`).textContent=Fl.length,document.getElementById(`minimap-soldiers`).textContent=Il.length;let n=new lr(new q(0,1,0),0),r=new ya,i=[new K(-1,1),new K(1,1),new K(1,-1),new K(-1,-1)],a=[];i.forEach(i=>{r.setFromCamera(i,ml);let o=new q;if(r.ray.intersectPlane(n,o)){let n=(o.x+t)*e,r=(o.z+t)*e;a.push({x:n,z:r})}}),a.length===4&&(Lu.strokeStyle=`rgba(255, 255, 255, 0.8)`,Lu.lineWidth=1,Lu.beginPath(),Lu.moveTo(a[0].x,a[0].z),Lu.lineTo(a[1].x,a[1].z),Lu.lineTo(a[2].x,a[2].z),Lu.lineTo(a[3].x,a[3].z),Lu.closePath(),Lu.stroke())}var zu=new Sa,Bu=0,Vu=performance.now();function Hu(){if(requestAnimationFrame(Hu),document.hidden){zu.getDelta();return}let e=zu.getDelta();e>.1&&(e=.1),au&&(e=0),!au&&!lu&&(_l.direction.x!==0||_l.direction.z!==0)&&(lu=!0);let t=document.getElementById(`countdown-display`);if(t){if(!lu)t.textContent=`방향키(W,A,S,D)를 눌러 군단을 이동시키면 시작됩니다`,t.style.color=`#ffff44`,t.style.fontWeight=`bold`,t.style.transform=`translateX(-50%) scale(1)`;else{let e=Ll-cu;Rl?(t.textContent=`군대 진입까지: ${Math.max(0,Math.ceil(e))}초`,e<=5?(t.style.color=`#ff3333`,t.style.fontWeight=`bold`,t.style.transform=`translateX(-50%) scale(1.2)`):(t.style.color=`white`,t.style.fontWeight=`normal`,t.style.transform=`translateX(-50%) scale(1)`)):(t.textContent=`다음 증원까지: ${Math.max(0,Math.ceil(e))}초`,t.style.color=`white`,t.style.fontWeight=`normal`,t.style.transform=`translateX(-50%) scale(0.8)`)}}if(lu&&!au){if(cu+=e,xl===`charging`||xl===`ready`){bl+=e,bl>=15&&xl===`charging`&&(xl=`ready`),bl>30&&(bl=30);let t=bl/15*100,n=document.getElementById(`flare-progress`),r=document.getElementById(`flare-text`);n&&r&&(n.style.height=`${Math.min(t,100)}%`,bl>=15?(n.style.background=`rgba(255, ${Math.max(0,255-(bl-15)/15*255)}, 0, 0.6)`,r.textContent=`READY`):(n.style.background=`rgba(255, 87, 34, 0.5)`,r.textContent=`${Math.ceil(15-bl)}s`))}else if(xl===`active`){if(Sl-=e,Sl<=0)xl=`charging`,bl=0,wl&&=(pl.remove(wl),wl.geometry.dispose(),wl.material.dispose(),null),ui&&(ui.style.height=`0%`),txt&&(txt.textContent=`0s`);else{let e=document.getElementById(`flare-progress`),t=document.getElementById(`flare-text`);e&&t&&(e.style.height=`100%`,e.style.background=`rgba(50, 150, 255, 0.6)`,t.textContent=`${Sl.toFixed(1)}s`)}}if(uu){let e=du(cu);uu.textContent!==e&&(uu.textContent=e)}let t=parseFloat(document.getElementById(`inp-sol-interval`).value)||15,n=parseInt(document.getElementById(`inp-sol-count`).value)||4;if(cu>=Ll){Ll=cu+t,Rl=!1;let e=Math.floor(Math.random()*4),r=$.mapSize/2-5;for(let t=0;t<n;t++){let t=0,n=0,i=(Math.random()-.5)*20;e===0?(t=r,n=i):e===1?(t=-r,n=i):e===2?(t=i,n=r):(t=i,n=-r);let a=Yl(t,n);Il.push(new Xc(pl,a.x,a.z))}}}Bu++;let n=performance.now();if(n-Vu>=1e3&&(document.getElementById(`fps-display`).textContent=Bu,Bu=0,Vu=n),!au){Fl.forEach(t=>{t.update(e,vl,Pl,Fl),vl.pushOutCollision(t,e);let n=!1;for(let e of Pl)if(e.hp>0&&e.mesh.position.distanceToSquared(t.mesh.position)<2.25){n=!0;break}n?(t.biteTimer===void 0&&(t.biteTimer=0),t.biteTimer+=e,t.isBeingBitten=!0,t.biteTimer>=$.stats.zombie.infectTime&&!t.isTransforming&&(t.isTransforming=!0,t.transformTimer=5,Yc.playScream())):(t.isBeingBitten=!1,t.biteTimer!==void 0&&t.biteTimer>0&&(t.biteTimer-=e*.5))});for(let e=Fl.length-1;e>=0;e--){let t=Fl[e];if(t.isTransforming&&t.transformTimer<=0){t.destroy(),Fl.splice(e,1);let n=[`normal`,`fast`,`slow`],r=n[Math.floor(Math.random()*n.length)];Pl.push(new qc(pl,r,t.mesh.position.x,t.mesh.position.z))}}Math.random()<.005*e*Pl.length&&Yc.playZombieGroan(),Il.forEach(t=>{t.update(e,vl,Pl,Il),vl.pushOutCollision(t,e);let n=!1;for(let e of Pl)if(e.hp>0&&e.mesh.position.distanceToSquared(t.mesh.position)<2.25){n=!0;break}n?(t.biteTimer===void 0&&(t.biteTimer=0),t.biteTimer+=e,t.isBeingBitten=!0,t.biteTimer>=$.stats.zombie.infectTime&&t.hp>0&&(t.hp=0)):(t.isBeingBitten=!1,t.biteTimer!==void 0&&t.biteTimer>0&&(t.biteTimer-=e*.5))}),Pl.forEach(t=>{t.update(e,_l.direction,vl,Pl,zl,_l.isStopped,xl===`active`?Cl:null,Fl,Il),vl.pushOutCollision(t,e)});for(let t=Pl.length-1;t>=0;t--){let n=Pl[t];if(n.hp<=0){Yc.playZombieDeath(),n.destroy(),Pl.splice(t,1);continue}for(let t=Il.length-1;t>=0;t--){let r=Il[t];if(n.mesh.position.distanceToSquared(r.mesh.position)<3){if(r.hp-=n.attack*e*5,r.mesh&&r.mesh.material){let e=r.origEmissive||r.mesh.material.emissive.getHex();r.origEmissive=e,r.mesh.material.emissive.setHex(16777215),r.flashTimer&&clearTimeout(r.flashTimer),r.flashTimer=setTimeout(()=>{r.mesh&&r.mesh.material&&r.mesh.material.emissive.setHex(e)},100)}if(r.hp<=0){r.destroy(),Il.splice(t,1);let e=[`normal`,`fast`,`slow`],n=e[Math.floor(Math.random()*e.length)];Pl.push(new qc(pl,n,r.mesh.position.x,r.mesh.position.z))}}}}}Ol.selectedObjects=Pl.map(e=>e.mesh),kl.selectedObjects=Fl.map(e=>e.mesh),Al.selectedObjects=Il.map(e=>e.mesh);let r=document.getElementById(`hud-zombie-count`);r&&(r.textContent=Pl.length);let i=document.getElementById(`hud-human-count`);i&&(i.textContent=Fl.length);let a=document.getElementById(`hud-soldier-count`);a&&(a.textContent=Il.length);let o=document.getElementById(`input-display`);o&&(o.textContent=_l.isStopped?`(${_l.direction.x.toFixed(2)}, ${_l.direction.z.toFixed(2)}) 정지됨`:`(${_l.direction.x.toFixed(2)}, ${_l.direction.z.toFixed(2)})`);let s=0,c=0,l=0;if(Pl.length>0){let e={};Pl.forEach(t=>{let n=`${Math.floor(t.mesh.position.x/15)},${Math.floor(t.mesh.position.z/15)}`;e[n]||(e[n]={count:0,sumX:0,sumZ:0,zombies:[]}),e[n].count++,e[n].sumX+=t.mesh.position.x,e[n].sumZ+=t.mesh.position.z,e[n].zombies.push(t)});let t=-1,n=null;for(let r in e)e[r].count>t&&(t=e[r].count,n=r);let r=n.split(`,`),i=parseInt(r[0]),a=parseInt(r[1]),o=[],u=0,d=0;for(let t=-1;t<=1;t++)for(let n=-1;n<=1;n++){let r=`${i+t},${a+n}`;e[r]&&(o.push(...e[r].zombies),u+=e[r].sumX,d+=e[r].sumZ)}s=u/o.length,c=d/o.length,o.forEach(e=>{let t=e.mesh.position.x-s,n=e.mesh.position.z-c,r=Math.sqrt(t*t+n*n);r>l&&(l=r)}),l>50&&(l=50),l<15&&(l=15),_l.isStopped||(s+=_l.direction.x*12,c+=_l.direction.z*12);let f=.05*10**(tu*2);f>1&&(f=1);let p=Cu?.05*10**(nu*2):0;p>1&&(p=1),!Wl&&!Gl&&(Vl+=(s-Vl)*f,Hl+=(c-Hl)*f,Ul+=(l-Ul)*p)}let u=Vl,d=Hl,f=Ul;Gl?(u=0,d=0,f=150):Wl&&(u=Kl,d=ql,f=Jl);let p=(30+f*2.5)*Ql;p>$l&&(p=$l);let m=p*.7*(1-eu);ml.position.x=u+0,ml.position.y=p,ml.position.z=d+m,yl.buildingMeshes&&yl.buildingMeshes.length>0&&yl.buildingMeshes.forEach(e=>{e.material.opacity!==1&&(e.material.opacity=1,e.material.transparent=!1)}),ml.lookAt(u+0,0,d),Ru(),El.render();let h=document.getElementById(`hud-canvas`);if(h){(h.width!==window.innerWidth||h.height!==window.innerHeight)&&(h.width=window.innerWidth,h.height=window.innerHeight);let e=h.getContext(`2d`);e.clearRect(0,0,h.width,h.height);let t=(t,n)=>{t.forEach(t=>{if(t.hp<t.maxHp&&t.hp>0){let r=t.mesh.position.clone();if(r.y+=2,r.project(ml),r.z<1){let i=(r.x*.5+.5)*h.width,a=-(r.y*.5-.5)*h.height;e.fillStyle=`rgba(0,0,0,0.8)`,e.fillRect(i-10,a,20,3),e.fillStyle=n,e.fillRect(i-10,a,t.hp/t.maxHp*20,3)}}})};t(Pl,`#ff3333`),t(Fl,`#33aaff`),t(Il,`#33ff33`),Pl.forEach(t=>{let n=t.mesh.position.clone();if(n.project(ml),n.z>=1||n.x<-1||n.x>1||n.y<-1||n.y>1){let t=au?340:0,r=(n.x*.5+.5)*h.width,i=-(n.y*.5-.5)*h.height;n.z>=1&&(r=h.width-r,i=h.height),r<20&&(r=20),r>h.width-t-20&&(r=h.width-t-20),i<20&&(i=20),i>h.height-20&&(i=h.height-20),e.fillStyle=`rgba(255, 50, 50, 0.8)`,e.beginPath(),e.arc(r,i,4,0,Math.PI*2),e.fill()}})}}window.addEventListener(`keydown`,e=>{if(e.target.tagName!==`INPUT`&&e.target.tagName!==`TEXTAREA`){if(e.code===`KeyF`){Wl=!1;let e=document.getElementById(`camera-mode`);e&&(e.textContent=`자동 추적`)}e.code===`Tab`&&(e.preventDefault(),Gl=!0)}}),window.addEventListener(`keyup`,e=>{e.code===`Tab`&&(Gl=!1)}),window.addEventListener(`wheel`,e=>{if(!(e.target.closest(`#ui-layer`)||e.target.closest(`.toggle-btn`)||e.target.closest(`#minimap-container`)||e.target.closest(`#flare-ui`))&&(e.preventDefault(),Wl||(Jl=Ul),Jl+=e.deltaY*.05,Jl<10&&(Jl=10),Jl>200&&(Jl=200),!Wl)){Kl=Vl,ql=Hl,Wl=!0;let e=document.getElementById(`camera-mode`);e&&(e.textContent=`자유 시점 (F로 복귀)`)}},{passive:!1});var Uu=!1,Wu=0,Gu=0;window.addEventListener(`mousedown`,e=>{if(!(e.target.closest(`#ui-layer`)||e.target.closest(`.toggle-btn`)||e.target.closest(`#minimap-container`)||e.target.closest(`#flare-ui`))&&(e.button===1||e.button===0)){if(e.preventDefault(),Uu=!0,!Wl){Kl=Vl,ql=Hl,Jl=Ul,Wl=!0;let e=document.getElementById(`camera-mode`);e&&(e.textContent=`자유 시점 (F로 복귀)`)}Wu=e.clientX,Gu=e.clientY}}),window.addEventListener(`mousemove`,e=>{if(Uu){let t=e.clientX-Wu,n=e.clientY-Gu;Wu=e.clientX,Gu=e.clientY;let r=ml.position.y/100;r<.1&&(r=.1);let i=ru*r;Kl-=t*i,ql-=n*i}}),window.addEventListener(`mouseup`,()=>{Uu=!1,Ku=!1}),window.addEventListener(`blur`,()=>{Gl=!1,Uu=!1,Ku=!1});var Ku=!1;function qu(e){let t=Iu.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top,i=$.mapSize,a=n/t.width*i-i/2,o=r/t.height*i-i/2,s=(30+Ul*2.5)*Ql;if(s>$l&&(s=$l),a-=0,!Wl){Wl=!0;let e=document.getElementById(`camera-mode`);e&&(e.textContent=`자유 시점 (F로 복귀)`),Jl=Ul}Kl=a,ql=o}Iu&&(Iu.addEventListener(`mousedown`,e=>{e.button===0&&(Ku=!0,qu(e))}),Iu.addEventListener(`mousemove`,e=>{Ku&&qu(e)})),window.addEventListener(`dblclick`,e=>{if(!(e.target.closest(`#ui-layer`)||e.target.closest(`.toggle-btn`)||e.target.closest(`#minimap-container`)||e.target.closest(`#flare-ui`))&&Tl&&e.button===0){let t=new K;t.x=e.clientX/window.innerWidth*2-1,t.y=-(e.clientY/window.innerHeight)*2+1;let n=new ya;n.setFromCamera(t,ml);let r=n.intersectObject(yl.groundMesh||yl.plane||pl,!0);if(r.length>0){Cl.copy(r[0].point),xl=`active`,Sl=Math.min(Math.max(bl/15*3,3),10),bl=0,Tl=!1,document.body.style.cursor=`default`;let e=document.getElementById(`flare-ui`);e&&(e.style.borderColor=`#666`),wl&&(pl.remove(wl),wl.geometry.dispose(),wl.material.dispose()),wl=new kr(new ni(.5,.5,5,8),new _r({color:16724787})),wl.position.copy(Cl),wl.position.y=2.5,pl.add(wl)}}}),Hu();